...
if ans ~= 1
    ...
    iS = ['05-01-2024/Steam_eruption_X0full-20240501-19-32-49.bin']
...
dec=200;% this is the decimation factor
fs=Fs/dec;
...
t1p = 300; t2p = 800; % begin and end times for analysis
mask = t>=t1p & t <= t2p;
...
watlev2 = (P(2,:)-pamb)*1e5/9.81/1e3; % in m above bottom of tank
