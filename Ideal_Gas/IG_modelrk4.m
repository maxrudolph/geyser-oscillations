...
par.sb = 613e-4; % cross-section of bubble trap in cm^2
par.sc = 5.07e-4;% cross-section of (1-inch) column in cm^2
par.sl = 7.92e-4; %cross-section of lateral connector in cm^2
par.L = 7.37e-2; % length of lateral connector in cm
...
par.H = 37.15e-2; % height of bubble trap in cm
